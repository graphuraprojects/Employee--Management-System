            ...
            <section className="mt-6 grid gap-4 md:grid-cols-4">
              <div className="rounded-2xl bg-white p-4 shadow-md border border-blue-100">
                ...
                <p className="text-3xl font-bold text-blue-600 mt-2">
                  {leaves.filter((leave) => leave.isHeadRequest).length}
                </p>
              </div>
                ...
                <p className="text-3xl font-bold text-green-600 mt-2">
                  {
                    leaves.filter(
                      (leave) =>
                        leave.isHeadRequest && leave.status === "approved",
                    ).length
                  }
                </p>
              </div>
                ...
                <p className="text-3xl font-bold text-yellow-600 mt-2">
                  {
                    leaves.filter(
                      (leave) =>
                        leave.isHeadRequest && leave.status === "pending",
                    ).length
                  }
                </p>
              </div>
                ...
                <p className="text-3xl font-bold text-red-600 mt-2">
                  {
                    leaves.filter(
                      (leave) =>
                        leave.isHeadRequest && leave.status === "rejected",
                    ).length
                  }
                </p>
              </div>
            ...
            <div className="bg-white rounded-3xl shadow-lg border border-blue-100 p-6">
              ...
              {leaves.filter((leave) => leave.isHeadRequest).length === 0 ? (
                ...
                <div className="space-y-3">
                  {leaves
                    .filter((leave) => leave.isHeadRequest)
                    .map((leave) => (
                      <div
                        key={leave._id}
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-2 flex-wrap">
                              <span
                                className={`text-xs font-semibold px-2 py-1 rounded ${getLeaveTypeColor(leave.leaveType)}`}
                              >
                                {leave.leaveType}
                              </span>
                              <span
                                className={`text-xs font-semibold px-2 py-1 rounded ${getStatusColor(leave.status)}`}
                              >
                                {leave.status}
                              </span>
                            </div>
              ...
              >
                  ...
                  <div>
                    ...
                    <div className="mt-3 p-3 rounded-lg bg-blue-50 border border-blue-200">
                      <p className="text-xs font-semibold text-blue-900">
                        {
                          leaveOptions.find((opt) => opt.value === leaveType)
                            ?.label
                        }
                      </p>
                    ...
                    <div>
                      ...
                      <div className="mt-2 relative">
                        <input
                          ...
                          className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                      </div>
                    </div>
                    <div>
                ...
                <div className="border border-slate-100 rounded-2xl p-4 bg-slate-50">
                  ...
                  <div
                    ...
                    onClick={() =>
                      document.getElementById("head-upload-input")?.click()
                    }
                    onDrop={(e) => {
                      e.preventDefault();
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          {uploadedFile.type.startsWith("image/") ? (
                            ...
                            <div className="w-12 h-12 rounded-md bg-slate-100 flex items-center justify-center text-slate-600 font-semibold text-sm">
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="px-3 py-2 text-xs rounded-lg border border-slate-200 text-slate-700 hover:bg-slate-50"
                          >
                            Remove
                          </button>
                        </div>
